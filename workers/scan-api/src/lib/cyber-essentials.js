...
// The self-attestation question set (internal controls we cannot observe
// externally) + the merge function that combines MEASURED external signal with
// the customer's answers. Core rule: a MEASURED gap overrides an optimistic
// self-attestation ("we have secure config" but we observe an exposed admin
// panel → flagged), which is what separates this from pure-questionnaire and
// pure-scanner tools. Readiness / gap analysis only — never certification.
//
...
export const CE_QUESTIONS = [
  { control_key: "boundary_protection", label: "Firewalls & Boundary Protection", questions: [
  ...
  { control_key: "secure_configuration", label: "Secure Configuration", questions: [
  ...
  { control_key: "access_control", label: "User Access Control", questions: [
  ...
  { control_key: "malware_protection", label: "Malware Protection", questions: [
  ...
  { control_key: "patch_management_readiness", label: "Security Update Management", questions: [

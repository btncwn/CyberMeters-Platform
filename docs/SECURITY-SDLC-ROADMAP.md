...
| 10 | Data retention + deletion verification | ✅→🟡 | Soft-delete + 30-day purge verified (beta checklist); add a standing regression test that purge removes ALL owned rows + R2 objects (the `workspace_assets` orphan class) |

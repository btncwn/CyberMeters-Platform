...
export const RESOURCE_CLASSES = [
  ...
  { class: "assets",                domain: "attack_surface", tables: ["workspace_assets", "hidden_assets"], harness: true, property: true },
  ...
  { class: "email_protection",      domain: "email",    tables: ["email_protection_events", "email_sender_sources", "dmarc_aggregate_records", "dmarc_aggregate_reports", "dmarc_change_requests", "dmarc_ingest_endpoints", "hosted_dns_entries", "hosted_dns_records", "tlsrpt_aggregate_reports", "tlsrpt_failure_details"], harness: false, property: false, coverage_note: "workspace_id-scoped; ingest is endpoint-key gated (key binds workspace); read surfaces harness-covered via /maturity + email-protection routes" },

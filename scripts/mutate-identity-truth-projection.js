...
const MUTANTS = [
  ...
  { id: "U3-M18", target: "snapshot", expected: ["U3-SNAP-RAW-01"], controls: ["U3-SNAP-LIVE-01"], replacements: [{ from: '  const customerSnapshot = projectPhase5SnapshotForCustomer(snapshot, sourceModules);', to: '  const customerSnapshot = projectPhase5SnapshotForCustomer(snapshot, sourceModules);\n  snapshot.overall = customerSnapshot.overall;' }] },

...

{
  ...
  sourceGuard("C1B subdomain CT and wildcard DNS carry accounting", subdomainsSrc,
    (s) => /dnsQuery\(wildcardHost, "A", \{ accounting, cache \}\)/.test(s) &&
      ...
      /ctCache\.get\(domain, provider, \{ accounting, module: "subdomains" \}\)/.test(s) &&

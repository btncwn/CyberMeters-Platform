...
export const CT_ISOLATION_SEMANTIC_MUTANTS = Object.freeze([
  mutant("DUPLICATE_PHYSICAL_REQUEST", ["SHARED_PHYSICAL_REQUEST_ONE", "CT_R1_LATE_SUCCESS_IS_OK"]),
  ...
  mutant("ACCEPT_LATE_RESULT_FOR_RELEASED_CONSUMER", ["RELEASED_CONSUMER_REJECTS_LATE_RESULT", "CONSUMER_STATE_SEPARATE_FROM_PHYSICAL"]),
  mutant("ALLOW_LATE_RESERVED_PUBLICATION", ["RELEASED_CONSUMER_REJECTS_LATE_RESULT", "CONSUMER_STATE_SEPARATE_FROM_PHYSICAL", "RELEASED_OUTPUT_IMMUTABLE"]),
  ...
  mutant("TYPO_PLATFORM_ABORT_WORDING", ["CUSTOMER_PLATFORM_ABORT_WORDING_EXACT", "SSL_SUBDOMAINS_PLATFORM_ABORT_WORDING_MATCH"]),
  ...
  mutant("OMIT_RESERVED_CONSUMER_BOUNDARY", ["RESERVED_PATH_USES_ISOLATED_BOUNDARY"]),
  mutant("SPLIT_CT_R1_OVERLAP_PROVENANCE", ["CT_R1_GLOBAL_DEADLINE_CAUSE", "CT_R1_OVERLAP_CAUSAL_COHERENCE"]),
  mutant("REPORT_CONSUMER_RELEASE_AS_PROVIDER_FAILURE", ["SSL_RELEASE_IS_CONSUMER_ONLY"]),
]);

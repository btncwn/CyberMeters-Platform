...
## v2026.07.22-8 — PR-A1: additive scan execution timing telemetry — deployed 2026-07-22; **MANUAL LIVE-ACCEPTED / SCHEDULED ACCEPTANCE PENDING**
...
- **Status: PR-A1 declared MERGED / DEPLOYED / MANUAL LIVE-ACCEPTED / SCHEDULED ACCEPTANCE PENDING** — the cron-context acceptance rides the next scheduled scan (19:00Z daily); no scheduled scan was fabricated. **Residual:** the 21s budget and the global complete-gate remain by design (deadline replacement = PR-B; per-signal completeness = PR-C/D — separate founder-gated episodes); public beta remains blocked.
